...
function LoginForm() {
  ...
  const { dataUser } = useSWR("http://127.0.0.1:3030/api/auth", (apiURL) =>
    fetch(apiURL, {
      method: "post",
      headers: {
        ...
        <div>
          <FormWrapper>
            <form>
              ...
              <LoginButton type="button" onClick={() => setFetch(true)}>
                Вход
              </LoginButton>
            </form>
          </FormWrapper>
  ...
  useSWR(!toFetch ? null : "http://127.0.0.1:3030/api/login/", (apiURL) =>
    fetch(apiURL, {
      method: "post",
      headers: {
        Accept: "application/json",
